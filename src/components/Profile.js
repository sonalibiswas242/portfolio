    ...
    >
      ...
      <Card
        sx={{
          ...
          alignItems: "center",
          borderRadius: "30px",
          padding: { xs: "20px", sm: "40px", md: "50px" }, // ✅ Responsive padding
        ...
        >
          ...
          <Box
            sx={{
              ...
              background:
                "linear-gradient(135deg, rgba(255,192,203,0.3), rgba(255,228,225,0.2))",
      ...
      <Box
        id="projects"
        data-aos="zoom-in-up"
        sx={{ padding: { xs: "10px 0", md: "0px 0" }, textAlign: "center" }}
      >
        <ProjectsSection />
      </Box>
      ...
      <Box
        id="contact"
        data-aos="fade-up"
        sx={{ padding: { xs: "30px 0", md: "20px 0" }, textAlign: "center" }}
      >
        <ContactSection />
      </Box>
    </Box>
